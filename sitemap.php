...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    ...
    <!-- Add other static pages like about-us.php if they exist -->
    ...
    // 2. Brands
    $brand_sql = "SELECT id, created_at FROM brands ORDER BY id DESC"; // Brands might not have updated_at
    ...
    if ($brand_res->num_rows > 0) {
        while ($brand = $brand_res->fetch_assoc()) {
            ...
            // Encode brackets for XML safety? standard browsers handle it, but pure XML safe url:
            // $url = "https://raenterprisesindia.in/products.php?brands%5B%5D=" . $brand['id'];
            // Let's use standard URL encoding
