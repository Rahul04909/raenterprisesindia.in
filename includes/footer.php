    ...
    <div class="container">
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="#">Video Door Phones</a></li>
            ...
            <div class="footer-section">
                ...
                <h3 class="footer-heading" style="margin-top: 20px; font-size: 16px;">Newsletter</h3>
        ...
        <div class="footer-bottom">
            ...
            <div class="developer-info">
                Designed by <span style="color: var(--accent-color);">Rahul</span>
            </div>
        </div>
    </div>
</footer>
