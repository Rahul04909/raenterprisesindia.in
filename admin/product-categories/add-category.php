...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($error)) {
        $sql = "INSERT INTO product_categories (brand_id, name, image, description, meta_title, meta_description, meta_keywords) 
                VALUES ($brand_id, '$name', '$image_path', '$description', '$meta_title', '$meta_description', '$meta_keywords')";
        
        if ($conn->query($sql) === TRUE) {
            $msg = "Category created successfully. <a href='index.php'>View All</a>";
        } else {
...
<head>
    ...
    <title>Add Product Category &lsaquo; RA Admin</title>
...
<div id="admin-content">
    <div class="wrap" style="max-width: 800px; margin: 20px;">
        <h1 style="font-weight: 400; font-size: 23px;">Add New Category</h1>
